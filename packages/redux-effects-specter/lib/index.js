...
var createFetchAction = function(payload) {
  return {
  ...
  return function() {
    return function(next) {
      return function(action) {
        ...
        if (type !== exports.SPECTER) return next(action);
        ...
        switch (payload.type) {
          case SPECTER_READ: {
            ...
            return client.read(req).then(function(res) {
              return res.body;
            });
          }
          case SPECTER_DELETE: {
            ...
            return client.delete(req).then(function(res) {
              return res.body;
            });
          }
          case SPECTER_CREATE: {
            ...
            return client.create(req).then(function(res) {
              return res.body;
            });
          }
          case SPECTER_UPDATE: {
            ...
            return client.update(req).then(function(res) {
              return res.body;
            });
          }
          default: {
