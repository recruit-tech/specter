...
export declare const specterRead: <H = object, Q = object>(
  service: string,
  args?: {
    query?: Q | undefined;
    headers?: H | undefined;
...
export declare const specterDelete: <H = object, Q = object>(
  service: string,
  args?: {
    query?: Q | undefined;
    headers?: H | undefined;
...
export declare const specterCreate: <H = object, Q = object, B = object>(
  service: string,
  args?: {
    query?: Q | undefined;
    body?: B | undefined;
...
export declare const specterUpdate: <H = object, Q = object, B = object>(
  service: string,
  args?: {
    headers?: H | undefined;
    query?: Q | undefined;
