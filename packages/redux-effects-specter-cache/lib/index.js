...
function reduxEffectsSpecterCache(_a) {
  var _this = this;
  var _b = _a.middlewareOption,
    middlewareOption = _b === void 0 ? {} : _b,
    _c = _a.cacheOption,
    cacheOption = _c === void 0 ? {} : _c;
  var excludes = middlewareOption.excludes,
    fromCache = middlewareOption.fromCache,
    toCache = middlewareOption.toCache,
    resetCache = middlewareOption.resetCache;
  ...
  return function(_a) {
    ...
    return function(next) {
      return function(action) {
        ...
        var cacheKey =
          "@@$" +
          redux_effects_specter_1.SPECTER +
          "/" +
          service +
          "@@" +
          JSON.stringify(
            ...
            return __generator(this, function(_a) {
              switch (_a.label) {
                ...
                case 2:
                  ...
                  return [
                    2 /*return*/,
                    next(action).then(function(resp) {
                      return __awaiter(_this, void 0, void 0, function() {
                        var manualCache;
                        return __generator(this, function(_a) {
                          switch (_a.label) {
                            case 0:
                              manualCache =
                                toCache && toCache(action, getState());
