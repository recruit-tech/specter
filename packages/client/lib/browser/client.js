...
var SpecterClient = /** @class */ (function() {
  function SpecterClient(options) {
    ...
    this.validateStatus =
      (_a = options.validateStatus) !== null && _a !== void 0
        ? _a
        : function(_s) {
            return true;
          };
      ...
      return __generator(this, function(_b) {
        switch (_b.label) {
          case 0:
            ...
            (_a = this.fetchOptions),
              (defaultHeaders = _a.headers),
              (options = __rest(_a, ["headers"]));
            ...
            return [
              ...
              method === "GET" || method === "HEAD"
                ? fetch(
                    path,
                    __assign({ method: method, headers: head }, options)
                  )
                : fetch(
                    path,
                    __assign(
                      { method: method, headers: head, body: body },
                      options
                    )
                  )
            ];
          ...
          case 2:
            ...
            if (!this.validateStatus(response.status)) {
              throw new specter_1.SpecterNetworkError(
