...
export default class SpecterClient {
  ...
  private async executeRequest(method: string, request: DefaultRequest): Promise<DefaultResponse> {
  ...
  async execute<Response extends DefaultResponse>(request: DefaultRequest): Promise<Response | DefaultResponse> {
    if (!request.method) {
  ...
  async create<Response extends DefaultResponse>(request: DefaultRequest): Promise<Response | DefaultResponse> {
    return this.executeRequest("POST", request);
  }

  async read<Response extends DefaultResponse>(request: DefaultRequest): Promise<Response | DefaultResponse> {
    return this.executeRequest("GET", request);
  }

  async update<Response extends DefaultResponse>(request: DefaultRequest): Promise<Response | DefaultResponse> {
    return this.executeRequest("PUT", request);
  }

  async delete<Response extends DefaultResponse>(request: DefaultRequest): Promise<Response | DefaultResponse> {
